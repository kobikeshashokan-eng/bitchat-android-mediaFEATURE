    ...
    Box(
        ...
        Column(
            ...
            ChatInputSection(
                ...
                // NEW: Add photo send handler
                onPhotoSend = { base64Data: String, fileName: String, mimeType: String ->
                    viewModel.sendPhotoMessage(base64Data, fileName, mimeType)
                    forceScrollToBottom = !forceScrollToBottom // Toggle to trigger scroll
                },
...
private fun ChatInputSection(
    ...
    onSend: () -> Unit,
    onPhotoSend: (String, String, String) -> Unit, // NEW: Photo send callback
    ...
    Surface(
        ...
        Column {
            ...
            MessageInput(
                ...
                onSend = onSend,
                onPhotoSend = onPhotoSend, // NEW: Pass photo send callback
                selectedPrivatePeer = selectedPrivatePeer,
                currentChannel = currentChannel,
                nickname = nickname,
                modifier = Modifier.fillMaxWidth()
